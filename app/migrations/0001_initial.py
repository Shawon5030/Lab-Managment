# Generated by Django 5.1.1 on 2025-09-05 09:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('available', 'Available'), ('pending', 'Pending'), ('in_loan', 'In Loan'), ('returned', 'Returned')], default='available', max_length=20)),
                ('in_stock', models.BooleanField(default=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.category')),
                ('lab', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='app.lab')),
            ],
        ),
        migrations.CreateModel(
            name='LoanRequest',
            fields=[
                ...
                ('for_student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requests_received', to=settings.AUTH_USER_MODEL)),
